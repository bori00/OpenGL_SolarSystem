...
namespace view_layer {
	...
	void SolarSystem::initPlanets() {
		...
		model_layer::Planet mercury_planet(mercuryPosition, 1408 * NO_SECONDS_IN_HOUR, glm::vec3(0, 1, 0), 88 * NO_SECONDS_IN_DAY, glm::vec3(0, 1, 0));
		...
		model_layer::Planet neptune_planet(neptunePosition, 16 * NO_SECONDS_IN_HOUR, glm::vec3(0, 1, 0), 59800.0 * NO_SECONDS_IN_DAY, glm::vec3(0, 1, 0));
